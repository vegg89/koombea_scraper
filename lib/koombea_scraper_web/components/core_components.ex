defmodule KoombeaScraperWeb.CoreComponents do
  @moduledoc """
      ...
      <table class="w-[40rem] mt-11 sm:w-full">
        ...
        >
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="group hover:bg-zinc-50">
            ...
            >
              <div class="block py-4 pr-6 truncate w-96">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KoombeaScraperWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KoombeaScraperWeb.Gettext, "errors", msg, opts)
    end
  end
